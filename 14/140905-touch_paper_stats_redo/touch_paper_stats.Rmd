...
```{r read_data}
fig1_data <- read.csv("touchData.csv.newline")
...
Positive interactions bascially mean that the effect is more positive in the
...
touched plants have longer (more positive) leaves than just the addition of
the effects of genotype and treatment.
